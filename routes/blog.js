...
const {getAll, create, deleteById, getById, updateById, likeBlogById, addNewCommentById} = require('../controllers/blogs')
...
router.patch('/blogs/:id/comments', addNewCommentById)
